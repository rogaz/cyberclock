...
class RentsControllerTest < ActionController::TestCase
  ...
  test "should create rent" do
    assert_difference('Rent.count') do
      post :create, rent: { computer_id: @rent.computer_id, duration: @rent.duration, name: @rent.name, rent_type: @rent.rent_type }
    end
  ...
  test "should update rent" do
    patch :update, id: @rent, rent: { computer_id: @rent.computer_id, duration: @rent.duration, name: @rent.name, rent_type: @rent.rent_type }
    assert_redirected_to rent_path(assigns(:rent))
  end
